...
# using MNIST dataset, it contains images of digits(from 0-9) and their labels
...
print("\nDifferent label values: ", num_labels)
...
def pixel_visualize(img):
    ...
    ax.set_xticks([])
    ax.set_yticks([])
    ax.set_title("Pixel Values Overlay")
    plt.tight_layout()
    plt.show()
...
# This step increases the sample size of dataset, to help counter overfitting
